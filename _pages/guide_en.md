...
* **Registration application(for the enrollment in October 2020)**
  ...
  Application form: Please download from here → [word](/doc/2020_Fall_Application form.docx), [pdf](/doc/2020_Fall_Application form.pdf)</B><br>
  <span style="color:#006aff">ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー</span><br>
  ...
  **Mid-term review: Thursday, September 17, 2020**
